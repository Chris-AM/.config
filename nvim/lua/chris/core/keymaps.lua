...
keymap.set("n", "<leader>q", ":q<CR>") --  go to previous tab
keymap.set("n", "<leader>q!", ":q!<CR>") --  go to previous tab
keymap.set("n", "<leader>wq", ":wq<CR>") --  go to previous tab
keymap.set("n", "<leader>w", ":w<CR>") --  go to previous tab
...
keymap.set("n", "<leader>ob", "<cmd>Telescope buffers<cr>") -- list open buffers in current neovim instance
